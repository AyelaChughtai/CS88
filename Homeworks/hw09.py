...
class Arr88():
    ...
    def __add__(self, arr88):
        ...
        return Arr88([self.item(i) + arr88.item(i) for i in range(len(self))])
    ...
    def negate(self):
        ...
        Arr88([-4.0, 5.5, -0.0])
        """
        self._values= [-1*self.item(i) for i in range(len(self))]
    ...
    def apply(self, func):
        ...
        Arr88([1, 2, 3])
        """
        return Arr88([func(self.item(i)) for i in range(len(self))])
...
class VendingMachine:
    ...
    def vend(self):
        ...
        if self.price < self.balance:
            message += ' and ${0} change'.format(self.balance - self.price)
        self.balance = 0
        self.stock -= 1
        return message + '.'
    ...
    #         self.stock -= 1
    #         return 'Here is your {0} and ${1} change.'.format(self.product,self.balance)
